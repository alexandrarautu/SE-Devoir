...
def main(argv=None):
    ...
    # Ajouter les threads pour Mademoisselle dans la fille d'attente
    for tasks3 in TASKS3:
        logging.info(tasks3)
        task_queue.put(tasks3)

    # Mettre en fonction le process ou il y a les threads
    ...
    # Ajouter les threads pour Madame dans la fille d'attente
    ...
    # Ajouter les threads pour Monsieur dans la fille d'attente
    for tasks1 in TASKS1: 
        logging.info(tasks1)
        task_queue.put(tasks1)
